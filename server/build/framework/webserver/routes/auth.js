...
const authRoute = () => {
    ...
    const controller = (0, authController_1.default)(userRepository_1.userRepositoryMongoDB, userRepositoryInterface_1.userRepository, authServices_1.authService, authServiceInterface_1.authServiceInterface, mailServices_1.mailService, mailServicesInterface_1.mailServiceInterface);
